...
export const CodepenIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const ThumbsUpIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M7 10v12" />
    <path d="M18 10V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v6H4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h2.76a2 2 0 0 1 1.79 1.11L12 22h7a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2h-1z" />
  </svg>
);
...
export const ThumbsDownIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M17 14V2" />
    <path d="M6 14v8a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-8h4a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-2.76a2 2 0 0 1-1.79-1.11L12 2H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h1z" />
  </svg>
);
...
export const Wand2Icon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="m3 21 1.6-1.6" />
    <path d="m18.4 5.6 1.6 1.6" />
    <path d="M4 14.5A2.5 2.5 0 0 1 6.5 12H12a2.5 2.5 0 0 1 2.5 2.5v5.5A2.5 2.5 0 0 1 12 22h-5.5a2.5 2.5 0 0 1-2.5-2.5Z" />
    <path d="M12 2h5.5A2.5 2.5 0 0 1 20 4.5v5.5a2.5 2.5 0 0 1-2.5 2.5H12a2.5 2.5 0 0 1-2.5-2.5V4.5A2.5 2.5 0 0 1 12 2Z" />
  </svg>
);
...
export const RocketIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.12-.67-.82-2.32-1.42-3.1-1.92s-.86-2.32-1.94-3.1c-1.08-.78-2.32-1.26-3.1-1.92-.78-.66-.5-2.32.05-3.12C2.8 5.6 2.8 4.08 2.25 3.38 1.7 2.68.5 3.5.5 5.5c0 2 1.5 2.5 3 2.5h1.5l1.5-1.5.5-3.5-3-3C2 2.5.5 4 .5 5.5"/>
    <path d="m12.5 11.5 11 11"/>
...
export const MessageSquareTextIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const BrainCircuitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.002 3.428V12a4 4 0 0 0 4 4h4a4 4 0 0 0 4-4v-3.447A4 4 0 0 0 14 5.25a3 3 0 0 0-2-.25" />
        <path d="M12 16v2a2 2 0 0 0 2 2h2" />
        <path d="M12 5V3a2 2 0 0 1 2-2h2" />
        <path d="M18 3a2 2 0 0 1 2 2v2" />
        <path d="M4 18a2 2 0 0 1-2-2v-2" />
